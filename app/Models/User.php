...
class User extends Authenticatable
{
    ...
    * $this->attributes['experience'] - string - contains the user experience
    * $this->attributes['laboratory'] - string - contains the user laboratory
    ...
    * $this->attributes['updated_at'] - timestamp - contains the user update date
    ...
    {
        return $this->attributes['laboratory'];
    }
    public function setLaboratory($laboratory)
    {
        $this->attributes['laboratory'] = $laboratory;
    }
